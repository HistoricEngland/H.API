...
**Mandatory in HGR**: Y\
**Data Type**: String\
**Description**: A unique number, or number and character combination, used to identify the data source, programatically populated during the submission process.\
**Validation Rules**: required, alpha\
**Acceptable Values**: Alphanumeric
